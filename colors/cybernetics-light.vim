" Vim color file - cybernetics-light
"
if version > 580
    hi clear
    if exists("syntax_on")
...
hi Normal guifg=#000000 guibg=#FFFFFF gui=NONE ctermfg=248 ctermbg=0 cterm=NONE
...
hi NormalFloat guifg=#000000 guibg=#FFFFFF gui=NONE ctermfg=248 ctermbg=NONE cterm=NONE
...
hi Comment guifg=#000000 guibg=#44EAA4 gui=italic ctermfg=59 ctermbg=NONE cterm=NONE
hi link SpecialComment Comment

hi String guifg=#444444 guibg=NONE gui=NONE ctermfg=242 ctermbg=NONE cterm=NONE
hi link Character String

hi Keyword guifg=#000000 guibg=NONE gui=NONE ctermfg=250 ctermbg=NONE cterm=NONE
hi Title guifg=#000000 guibg=NONE gui=NONE ctermfg=250 ctermbg=NONE cterm=NONE
hi Typedef guifg=#000000 guibg=NONE gui=NONE ctermfg=250 ctermbg=NONE cterm=NONE
hi Conditional guifg=#000000 guibg=NONE gui=NONE ctermfg=250 ctermbg=NONE cterm=NONE
hi Operator guifg=#000000 guibg=NONE gui=NONE ctermfg=250 ctermbg=NONE cterm=NONE

hi Delimiter guifg=#000000 guibg=NONE gui=NONE ctermfg=188 ctermbg=NONE cterm=NONE
...
hi Function guifg=#000000 guibg=NONE gui=bold ctermfg=178 ctermbg=NONE cterm=bold
...
hi Special guifg=#000000 guibg=NONE gui=NONE ctermfg=178 ctermbg=NONE cterm=NONE
...
hi LineNr guifg=#777777 guibg=#FFFFFF gui=NONE ctermfg=238 ctermbg=0 cterm=NONE
hi StatusLine guifg=#333333 guibg=#FFFFFF gui=bold ctermfg=240 ctermbg=0 cterm=bold
...
hi Boolean guifg=#000000 guibg=NONE gui=NONE ctermfg=248 ctermbg=NONE cterm=NONE
...
hi MatchParen guifg=#000000 guibg=#D4D4D4 gui=bold ctermfg=233 ctermbg=248 cterm=bold
...
hi Underlined guifg=#000000 guibg=#D4D4D4 gui=underline ctermfg=189 ctermbg=235 cterm=underline
...
hi cursorlinenr guifg=#000000 guibg=NONE gui=bold ctermfg=248 ctermbg=NONE cterm=bold
...
hi Constant guifg=#000000 guibg=NONE gui=NONE ctermfg=248 ctermbg=NONE cterm=NONE
...
if has('nvim')
  if exists('g:loaded_nvim_treesitter')
    ...
    hi @variable guifg=#000000 guibg=NONE gui=NONE ctermfg=248 ctermbg=0 cterm=NONE
    ...
    hi @keyword.conditional guifg=#000000 guibg=NONE gui=NONE ctermfg=188 ctermbg=NONE cterm=NONE
    hi @keyword.return guifg=#000000 guibg=NONE gui=NONE ctermfg=188 ctermbg=NONE cterm=NONE
    hi @keyword.import guifg=#000000 guibg=NONE gui=NONE ctermfg=188 ctermbg=NONE cterm=NONE
  endif
endif
